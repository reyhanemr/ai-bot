...
<head>
    ...
    <link rel="stylesheet" href="/tailwind/assets/app-D6vOz8eM.css">
    <script src="/tailwind/assets/app-CXDpL9bK.js"></script>
        ...
        <div class="p-6 animate__animated" :class="[$store.app.animation]">
            <div x-data>
                <ul class="flex space-x-2 rtl:space-x-reverse">
                    <li>
{{--                        <a href="{{route('admin.dashboard')}}" class="text-primary hover:underline">داشبورد</a>--}}
                    </li>
...
<script defer src="{{ url('panel/js/alpine-collapse.min.js') }}"></script>
<script defer src="{{ url('panel/js/alpine-persist.min.js') }}"></script>
<script defer src="{{ url('panel/js/alpine-ui.min.js') }}"></script>
<script defer src="{{ url('panel/js/alpine-focus.min.js') }}"></script>

<!-- حالا custom.js بعد از همه پلاگین‌ها -->
<script defer src="{{ url('panel/js/custom.js') }}"></script>
